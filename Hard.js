...
function setLevel(level) {
    if (level === "2") {
        ...
        HIDE_TIME = 0.5;
        SHOW_CLL = 0.5;
        maxScorePerLevel = 90; // ด่าน 2
    } else if (level === "3") {
        coinsEarned = 120;
        SHOW_TIME = 0.4;
        HIDE_TIME = 0.5;
        SHOW_CLL = 0.5;
        maxScorePerLevel = 100; // ตัวอย่างสำหรับด่าน 3
    } else if (level === "4") {
        coinsEarned = 150;
        SHOW_TIME = 0.4;
        HIDE_TIME = 0.4;
        SHOW_CLL = 0.5;
        maxScorePerLevel = 120; // ตัวอย่างสำหรับด่าน 4
    } else if (level === "5") {
        coinsEarned = 200;
        SHOW_TIME = 0.4;
        HIDE_TIME = 0.4;
        SHOW_CLL = 0.4;
        maxScorePerLevel = 140; // ตัวอย่างสำหรับด่าน 5
    } else {
        coinsEarned = 80;
        SHOW_TIME = 0.5;
        HIDE_TIME = 0.5;
        SHOW_CLL = 0.5;
        maxScorePerLevel = 80; // ด่านเริ่มต้น
    }
